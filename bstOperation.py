...
class Bst:
    ...
    def add_node(self):
        ...
        if self.root is None: # if tree is empty
            self.root = node # make the new node as the root
            return
        temp1 = self.root
        temp2 = None
        while temp1 != None:
    ...
    def delete_node(self):
        ...
        if temp1 is self.root:
            if temp1.left is None and temp1.right is None: # if the root is the only node in the tree
                self.root = None
